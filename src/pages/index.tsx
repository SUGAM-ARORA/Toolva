            ...
            <div className="mb-8">
              <div className="flex flex-col md:flex-row gap-4 mb-6">
                <input
                  ...
                  className="flex-1 px-4 py-2 border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
                <select
  ...
  <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md transition-shadow p-6">
    <div className="flex items-start justify-between">
      <div>
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">{tool.category}</p>
      </div>
    ...
    <p className="mt-3 text-sm text-gray-600 dark:text-gray-300 line-clamp-2">{tool.description}</p>
